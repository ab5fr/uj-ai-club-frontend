...
export default function ResourcesPage() {
  ...
  const newLocal =
    "bg-[color-mix(in_srgb,var(--color-danger)_25%,transparent)] border border-[var(--color-danger)] text-[var(--color-warning)] px-6 py-4 rounded-2xl mb-8";
  return (
    <main className="min-h-screen bg-(--color-surface-2) text-(--color-text) pt-24">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {/* Error Message */}
        {error && <div className={newLocal}>{error}</div>}
