...
export default function ArcadePage() {
  const [activeView, setActiveView] = useState("challenges"); // challenges or leaderboard
    ...
    <main className="min-h-screen bg-black pt-24 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex justify-center gap-16 text-white text-xl mb-12">
          <button
            className={`font-bold transition-opacity ${
              activeView === "leaderboard" ? "" : "opacity-50 hover:opacity-100"
            }`}
          ...
          <button
            className={`font-bold transition-opacity ${
              activeView === "challenges" ? "" : "opacity-50 hover:opacity-100"
            }`}
        ...
        {activeView === "leaderboard" ? (
          ...
          // Challenges view content
          <div className="text-white">
            {/* Add your challenges content here */}
            <h2>Week 1 Challenge</h2>
            {/* ... rest of your challenges content */}
          </div>
        )}
      </div>
    </main>
